    ...
    <>
      ...
      */}
      <main className=" font-Shabnam bg-gray-100   min-h-screen      ">
        <Image src="/bg1.png" alt='bg1' width={2560} height={2525} className='top-[44.39] left-[5] hidden md:block fixed lg:w-[1000] lg:h-[] lg:top-[] lg:left-[270] lg:fixed ' />
        <Image src="/bg2.png" alt='bg2' width={500} height={1421.26} className='top-[290] left-[140] hidden md:block fixed lg:w-[700] lg:h-[] lg:top-[340] lg:left-[415]' />
        <Image src="/bg3.png" alt='bg3' width={300} height={912.73} className='top-[390] left-[243] hidden md:block fixed lg:w-[400] lg:h-[] lg:top-[470] lg:left-[570]' />
        <Image src="/bg4.png" alt='bg4' width={200} height={456.37} className='top-[470] left-[296] hidden md:block fixed lg:w-[] lg:h-[] lg:top-[575] lg:left-[675]' />

        <main className=''>
      <Image src="/bgPhone1.png" alt='bgPhone1' width={562.59} height={554.7} className='top-[45] left-[15]  lg:w-[300px] lg:h-[390px] lg:top-[170px] lg:left-[630px] md:w-[370] md:h-[412] md:top-[112] md:left-[200] md:bg-[#FFFFFF]   lg:bg-[#FFFFFF]  fixed '  />
          ...
          <div className="card-body ">
            ...
            <div className="form-control w-full">
              <label className="label" htmlFor="phone-input">
                <span className="label-text w-[177] h-[16] top-[700] left-[210] font-bold size-[16] text-[#1B2559] lg:w-[177] lg:h-[16] lg:top-[410] lg:left-[720] lg:fixed fixed md:w-[] md:h-[] md:top-[350] md:left-[350]">شماره همراه خود را وارد کنید</span>
              </label>
              <div className="fixed">
            ...
            <div className="form-control mt-6 bg-[#278760] w-[366] h-[62] top-[810] left-[55] rounded-[7] border-[1] lg:w-[250] lg:h-[42] lg:top-[479] lg:left-[660] lg:fixed fixed md:w-[300] md:h-[38] md:top-[430] md:left-[231] md:cursor-pointer cursor-pointer  ">
              ...
              */}
              <button className="flex text-center justify-center w-[350]  items-center top-[850]  text-[#100f0f]  lg:w-[81] lg:h-[27] lg:top-[510] lg:left-[740] lg:fixed  md:w-[300] md:h-[300] md:top-[320] md:left-[]  fixed">ارسال پیامک</button>
            </div>
